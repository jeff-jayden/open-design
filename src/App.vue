<template>
  <div class="container">
    ...
    <Collapse :model-value="value" @change="fn" accordion>
      ...
      <collapse-item name="2" title="Feedback"> dsfasdfds </collapse-item>
      <collapse-item name="3" title="Efficiency"> sass </collapse-item>
    </Collapse>
    ...
    <el-tooltip content="dksjdkjasdkl" effect="dark"> el-tooltip </el-tooltip>
    ...
    <div>
      ElTooltip
      <ElTooltip content="Top Left prompts info" placement="top-start" trigger="click">
        <el-button type="primary">top-start</el-button>
      </ElTooltip>
      <br />
      OpenToolTip
      <OpenToolTip content="Top Left prompts info" placement="top" trigger="click" effect="dark">
    ...
    <div>
      如何实现的校验 OpenForm
      <OpenForm :model="form" :rules="rules">
      ...
      <Form :rules="rules" :model="form">
        <FormItem label="Activity name" prop="name">
...
import Switch, { Form, FormItem, Input } from '@qinloong/snow-sky';

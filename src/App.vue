...
<!--    <OpenButton type="primary" :loading="true" icon="arrow-down">Primary</OpenButton>-->
...
<!--    -->
<!--    &lt;!&ndash;    <message message="这是openMessage" show-close type="success"></message>&ndash;&gt;-->
<!--    &lt;!&ndash;    <message message="这是openMessage" show-close type="success"></message>&ndash;&gt;-->
<!--    &lt;!&ndash;    <open-message message="这是openMessage" show-close type="success"></open-message>&ndash;&gt;-->
<!--    &lt;!&ndash;    <open-message message="这是openMessage" show-close type="success"></open-message>&ndash;&gt;-->
<!--    -->
...
<!--    ></OpenSwitch>-->
<!--    {{ switchvalue }}-->
<!--    &lt;!&ndash;    <Switch v-model="value1"/>&ndash;&gt;-->
<!--    -->
<!--    <div>-->
<!--      ElTooltip-->
<!--      <ElTooltip-->
...
<!--  </div>-->
  <div>
    <OpenButton :icon="Check"></OpenButton>
    <ElButton></ElButton>
  </div>
</template>

...
<div class="circle block">
  <open-button circle :icon="Search">  </open-button>
  <open-button type="primary" circle :icon="Share">  </open-button>
  <open-button type="success" circle :icon="Delete">  </open-button>
  <open-button type="warning" circle :icon="Star">  </open-button>
  <open-button type="danger" circle :icon="Close">  </open-button>
  <open-button type="info" circle :icon="Monitor">  </open-button>
</div>
</template>
<script setup>

<template>
  <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="auto" inline-message>
    <el-form-item label="Activity name" prop="name" :show-message="false">
      <el-input v-model="ruleForm.name" style="width: 100px" />
    </el-form-item>
    <el-form-item label="Activity zone" prop="region" inline-message style="width: 700px">
